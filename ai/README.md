...
- **prompt-engineering** — write or revise an LLM agent/persona system prompt: don't repeat the shared base, the `Role:`/`How you work:`/`Boundaries:` shape, and 12 distilled principles tuned for modern Claude models
